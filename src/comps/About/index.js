        ...
        <div className="aboutWrapper">
          ...
          <div className="aboutRow">
            ...
            <p className="aboutText">
              I'm a Front-End developer with a passion for coding that started
          ...
          <p className="skillsDesc">
            ...
            skills. The variety of courses have given knowledge and experience
            in digital marketing, digital design, project management, business
            communications, and web & mobile development. Due to the 8-10
            courses each semester, I have improved on my time management and
            have complied with project schedules on a consistant basis. <br />
            <br />
            <br />
