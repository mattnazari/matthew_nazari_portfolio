    ...
    <div>
      ...
      <section className="summary">
        <div className="summaryCont">
          ...
          <p className="sumDesc">
            Fitly is a workout routine creation website based on your experience
            in working out and what body parts you would like to work. The
            research, design, and development was done by Micah Mones and myself
            for our Design 1 class. The objective of the project was to create a
            website that passes information to the next page based on what you
            select without any frameworks and libraries.
          </p>
