    ...
    <div>
      ...
      <section className="summary">
        <div className="summaryCont">
          ...
          <p className="sumDesc">
            QuikPix is a photo resolution adjusting app that changes your photos
            resolutions to fit the needs of whatever social media platform you
            would like to upload to. I am currently working on this project with
            2 designers and 1 other developer for our Advance Dynamic Content
            Design class.
          </p>
